...
class Apiklaimcontroller extends Restdata{
  ...
  function klaim_get(){
    $no_member = (int) $this->get('no_member',TRUE);
    ...
    $data = ($no_member) ? $this->mymodel->selectklaimwhere($no_member, $uw_year, $cover_type) : $this->mymodel->selectklaim();
    print_r($data); die;
    ...
    if ($data) {
      ...
      $this->response($data,Restdata::HTTP_OK);
        ...
        $this->notfound('Data Klaim Tidak Di Temukan');
